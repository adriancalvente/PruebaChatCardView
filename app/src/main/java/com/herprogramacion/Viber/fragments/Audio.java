...
public class Audio extends Fragment {
    ...
    private void declararObjetos(View inflate) {
        ...
        cambioEspectro = inflate.findViewById(R.id.cambioEspectro2);
        lineVisualizer = inflate.findViewById(R.id.visualizerLine2);
        barVisualizer = inflate.findViewById(R.id.visualizerBar2);
        squareBarVisualizer = inflate.findViewById(R.id.visualizerSquareBar2);
        circleBarVisualizer = inflate.findViewById(R.id.visualizerCircleBar2);
        circleVisualizer = inflate.findViewById(R.id.visualizerCircle2);
        lineBarVisualizer = inflate.findViewById(R.id.visualizerLineBar2);
